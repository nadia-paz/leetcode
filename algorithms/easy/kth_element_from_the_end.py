...
- The slow and fast pointers should then move forward in the list at the same time 
...
def find_kth_from_end(ll, k):
    """
    ll: linked list
    k: integer, Kth index from the end
    """
    # slow pointer
    slow = ll.head
    # fast pointer to move k-steps ahead
    fast = ll.head
    try:
        for _ in range(k):
            fast = fast.next
